...
int main(int argc, char** argv)
{
	...
	graph.setNumLevels(5);
	graph.setNumNodes(9);
	// tambahkan node
	graph.addNode(1, 1, 1.0f);
	graph.addNode(2, 1, 1.0f);
	graph.addNode(3, 4, 1.0f);
	graph.addNode(4, 4, 1.0f);
	graph.addNode(6, 2, 1.0f);
	graph.addNode(0, 2, 1.0f);
	graph.addNode(7, 2, 1.0f);
	graph.addNode(5, 3, 1.0f);
	graph.addNode(8, 0, 1.0f);
	// tambahkan edge
	graph.addEdge(0, 1);
	graph.addEdge(0, 2);
	graph.addEdge(0, 3);
	...
	glutCreateWindow("LUTFAN ALAUDIN NAJA / 2400018032 - ALGORITMA BACKTRACKING");
