...
void drawObject()
{
	...
	Vec3 p0 = Vec3(-300.0f, -250.0f, 0.0f); // ditarik jauh ke bawah
	Vec3 p1 = Vec3(-200.0f, -100.0f, 0.0f);
	Vec3 p2 = Vec3( 200.0f,  150.0f, 0.0f);
	Vec3 p3 = Vec3( 300.0f,  300.0f, 0.0f); // dinaikkan lebih tinggi
